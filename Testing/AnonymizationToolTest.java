 ...
 * 
 * @authors Dr. Hamzah AlZu’bi & Raz M. Yousufi
 * @version 1.0
 ****************************************************************************************************************/
...
public class AnonymizationToolTest {
    static StringBuilder mappedData = new StringBuilder(); // StringBuilder to store the mapped data and their IDs

    public static void main(String[] args) {
        // Input and output filenames
        String inputFilename = "Test_PatientNotes.txt";
        String outputFilename = "Test_AnonymizedData.txt";
        String mappedFilename = "Test_MappedData.txt"; // Renamed to avoid confusion
